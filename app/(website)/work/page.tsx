				...
				<section className="relative pt-20 lg:pt-28">
					<div className="max-w-7xl mx-auto px-8 lg:px-12">
						<div className="text-right mb-12">
							<h1 className=" font-black text-6xl sm:text-7xl lg:text-8xl leading-none text-black">Our Work</h1>
							<p className=" font-medium text-lg lg:text-2xl text-black mt-3">who we are</p>
						</div>
					</div>
