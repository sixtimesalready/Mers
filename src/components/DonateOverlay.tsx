  ...
  return (
    <div className="absolute inset-0 flex items-center justify-center px-4">
      ...
      >
        ...
        >
          <motion.div
            className="w-16 h-16 lg:w-[100px] lg:h-[100px] rounded-full overflow-hidden border-2 lg:border-4 border-white shrink-0 shadow-md"
            variants={logoVariants}
          >
            <img src={IMAGES.MERS_LOGO} alt="MERS" className="w-full h-full object-cover" />
          </motion.div>
          <p className="font-sans font-black text-3xl lg:text-5xl xl:text-6xl text-black leading-none">
            Donate Now
          </p>
        </motion.div>

        <motion.div
          className="w-14 h-14 lg:w-20 lg:h-20 bg-black rounded-full flex items-center justify-center shrink-0 shadow-md"
