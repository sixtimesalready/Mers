...
const faqs: FAQItem[] = [
  {
    ...
    answer: "MeRS addresses period poverty by shifting away from unpredictable, short-term charity drives and instead establishing permanent, digitally accountable public health infrastructure. Our systemic approach is built on a unique triple-loop ecosystem that seamlessly combines advanced software, local community nodes, and clinical public health strategy.",
  },
  {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-4">
      {faqs.map((faq, index) => (
        <div
          key={index}
          className="bg-white rounded-2xl shadow-[0px_4px_10.8px_rgba(0,0,0,0.25)] overflow-hidden"
        >
          <button
          ...
          <AnimatePresence>
            {openIndex === index && (
              ...
              >
                <div className="px-6 pb-5 text-sm lg:text-base text-gray-600 leading-relaxed">
                  {faq.answer}
                </div>
              </motion.div>
            )}
